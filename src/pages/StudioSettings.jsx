      ...
      <Grid cols={2} gap={10}>
        <div>
          ...
          <Card>
            ...
            {[['Fast','claude-3-haiku-20240307','Fastest, lower cost'],['Balanced','claude-3-5-sonnet-20240620','Best quality/speed'],['Max','claude-3-opus-20240229','Highest quality']].map(([tier,model,desc],i)=>(
